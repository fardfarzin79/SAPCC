...
C_captotal = Z_absorber_capital+Z_pump_capital+Z_HX_capital+Z_capital_solar+Z_stripper_capital+3*Z_cooler_capital+2*Z_capital_comp+2*Z_capital_seperator 
h = 8000
...
C_D_plant = c_fuel*(Ex_D_st+Ex_D_abs+Ex_D_pump+Ex_D_compr+Ex_D_HX+Ex_D_cooler_2+Ex_D_cooler+Ex_D_sep_R+Ex_D_sepl+Ex_D_cooler_2l+Ex_D_compl+Ex_D_pu2+Ex_D_col)*0.0036
