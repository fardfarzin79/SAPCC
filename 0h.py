...
#coolector
Ex_1_col = ex_1_col*m_1_col
Ex_2_col = ex_2_col*m_1_col
#with applied 70% efficiency
Ex_F_col = Ex_1_col+solar
Ex_P_col = Ex_2_col
...
Ex_F_PV = ((1-(4/3)*(T_amb/T_s)+(1/3)*(T_amb/T_s)**4)*G*A)*0.001
Ex_P_PV = (U*I-(1-(T_amb/T_cell))*alpa*A)*0.001
Ex_D_PV = (Ex_F_PV-Ex_P_PV)
psi_PV = Ex_P_PV/Ex_F_PV

#plant
Ex_F_plant  = Ex_F_PV+Ex_F_abs+Ex_F_pump+Ex_F_HX+Ex_F_st+Ex_F_col+Ex_F_sep_R+Ex_F_compr+Ex_F_cooler_2+Ex_F_pu2+Ex_F_cooler+Ex_F_sepl+Ex_F_compl+Ex_F_cooler_2l
Ex_P_plant = Ex_P_PV+Ex_P_abs+Ex_P_pump+Ex_P_HX+Ex_P_st+Ex_P_col+Ex_P_sep_R+Ex_P_compr+Ex_P_cooler_2+Ex_P_pu2+Ex_P_cooler+Ex_P_sepl+Ex_P_compl+Ex_P_cooler_2l

Ex_D_plant = Ex_F_plant-Ex_P_plant
psi_plant = Ex_P_plant/Ex_F_plant





C_captotal = Z_capital_PV+Z_absorber_capital+Z_pump_capital+Z_HX_capital+Z_capital_solar+Z_stripper_capital+3*Z_cooler_capital+2*Z_capital_comp+2*Z_capital_seperator 
h = 8000
...
C_D_plant = c_fuel*(Ex_D_PV+Ex_D_st+Ex_D_abs+Ex_D_pump+Ex_D_compr+Ex_D_HX+Ex_D_cooler_2+Ex_D_cooler+Ex_D_sep_R+Ex_D_sepl+Ex_D_cooler_2l+Ex_D_compl+Ex_D_pu2+Ex_D_col)*0.0036
