...
#compressor
Ex_F_comp = w_comp+Ex_1
Ex_P_comp = Ex_1_2
Ex_D_comp = Ex_F_comp-Ex_P_comp
psi_comp = Ex_P_comp/Ex_F_comp

#cooler comp

Ex_F_cocomp = w_cocomp+Ex_1_2
Ex_P_cocomp = Ex_1_3
Ex_D_cocomp = Ex_F_cocomp-Ex_P_cocomp
psi_cocomp = Ex_P_cocomp/Ex_F_cocomp

#pump absorber
Ex_F_pump_abs = w_pump_abs+Ex_2
Ex_P_pump_abs = Ex_2_2
Ex_D_pump_abs = Ex_F_pump_abs-Ex_F_pump_abs
psi_pump_abs = Ex_P_pump_abs/Ex_F_pump_abs
...
psi_plant = (Ex_P_cocomp+Ex_p_abs+Ex_P_comp+Ex_P_pump+Ex_P_HX+Ex_P_ST+Ex_P_CO)/(Ex_F_abs+Ex_F_pump+Ex_F_HX+Ex_F_ST+Ex_F_CO+Ex_F_comp+Ex_F_cocomp)
...
C_captotal = Z_capital_comp+Z_absorber_capital+2*Z_pump_capital+Z_HX_capital+Z_stripper_capital+2*Z_cooler_capital 
h = 8000
...
#comp
c_1_2= c_power_pump+(((c_1*Ex_1*0.0036)+Z_dot_comp_1+(c_power_pump*w_comp*0.0036))/(Ex_1_2*0.0036))
C_D_compr = (c_1+c_power_pump)*Ex_D_comp*0.0036
r_compr = (c_1_2-c_power_pump-c_1)/(c_power_pump+c_1)
f_compr = (Z_capital_comp/h)/((Z_capital_comp/h)+C_D_compr)

#absorber
c_4 = (Z_dot_absorber+(c_2*Ex_2*0.0036+c_1_2*Ex_1*0.0036-c_3*Ex_3*0.0036))/(Ex_4*0.0036)
       
C_D_absorber = (c_1_2+c_2)*(Ex_D_abs+Ex_loss_abs)*0.0036
r_abs = c_4-c_2-c_1_2/(c_2+c_1_2)
...
C_D_plant = c_fuel*(Ex_D_ST+Ex_D_abs+Ex_D_pump+Ex_D_HX+Ex_D_CO+Ex_D_comp+Ex_D_cocomp)*0.0036
