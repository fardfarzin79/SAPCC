...
#Absorber
Ex_F_abs = Ex_1+Ex_2+Ex_2_1+Ex_2_2
Ex_p_abs = Ex_4
Ex_loss_abs = Ex_3
...
#Heat exchanger2
Ex_F_HX2 = Ex_5-Ex_4_1
Ex_P_HX2 = Ex_2_2-Ex_2_1
Ex_D_HX2 = Ex_F_HX2-Ex_P_HX2
psi_HX2 = Ex_P_HX2/Ex_F_HX2
...
psi_plant = (Ex_P_HX2+Ex_p_abs+Ex_P_pump+Ex_P_HX+Ex_P_ST+Ex_P_CO)/(Ex_F_abs+Ex_F_HX2+Ex_F_pump+Ex_F_HX+Ex_F_ST+Ex_F_CO)
...
C_captotal = Z_absorber_capital+Z_pump_capital+2*Z_HX_capital+Z_stripper_capital+Z_cooler_capital 
h = 8000
